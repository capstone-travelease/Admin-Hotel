...
import com.capstone.HotelAdmin.DTOs.ResponseHotelListStatus;
...
//    @CrossOrigin("*")
    ...
    @GetMapping("/approve-hotels")
    public ResponseHotelListStatus ListHotelsApproved(){
        return new ResponseHotelListStatus(
                200,
                approveService.ListHotelApproved(),
                "Successful"
        );
    }
}
