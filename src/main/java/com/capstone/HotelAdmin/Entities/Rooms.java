...
public class Rooms {
    ...
    public Rooms(Integer room_id, String room_name, String room_images, Integer room_status, Double room_price, Integer room_type_id, Integer hotel_id, Integer room_quantity) {
